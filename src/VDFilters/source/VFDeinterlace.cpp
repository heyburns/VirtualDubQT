...
#if defined(VD_CPU_X86) || defined(VD_CPU_AMD64) || defined(__x86_64__) || defined(__i386__)
	#include <emmintrin.h>
#endif
...
static void __declspec(naked) asm_blend_row_MMX(void *dst, const void *src, uint32 w, ptrdiff_t srcpitch) {
	static const __declspec(align(8)) __int64 mask0 = 0xfcfcfcfcfcfcfcfcLL;
	static const __declspec(align(8)) __int64 mask1 = 0x7f7f7f7f7f7f7f7fLL;
	static const __declspec(align(8)) __int64 mask2 = 0x3f3f3f3f3f3f3f3fLL;
	__asm {
		push	ebp
		push	edi
		push	esi
